...
After this activity:
 ...
 - You will be familiar with the core utilitiers and general workflow for developing a model using the `{idymodels}` framework in R 
...
This dataset was curated and provided in the TAME project mentioned above
...
Files `ID.txt`,`class.csv` and `X.csv` in folder `./data/qsar` were obtained from the author of the paper above via personal communication. Orinal sources files (Matlab scripts and matrix files can be downloaded from the paper's DOI as supplemental data). They are included here for reproducibility reasons in `./data/qsar/oral_toxicity_data.rar`
